            ...
            <Container style={styles.container}>                
                ...
                <View>
                    <Button style={styles.btn} onPress={()=> this.flipCard() } transparent danger block >
                        <Text style={{fontSize:20, marginBottom: 10, color: "#ffffff"}}>{this.state.flipButtonText}</Text>
                    </Button>
                </View>
                <View style={{flex:1}}>
    ...
    renderIfQuestionDoesNotExists(){
        return (
            <Container style={styles.noQuizcontainer}>                
                <View >
                    <Text style={{fontSize:20, alignSelf:"center", marginLeft:20, marginRight:20, color:colors.textColor}}>Sorry, you cannot take a quiz because there are no cards in the deck.</Text>
                </View>
            </Container>
        );
    }
